		...
		<div class="row h-auto align-items-center text-center">
			<nav id="paginationBox">
				<ul class="pagination align-items-center justify-content-center">
					<c:if test="${page.prev}">
						<li class="page-item"><a class="page-link" href="<%=request.getContextPath()%>/admin?num=${page.startPageNum - 1}"
					...
					<c:forEach begin="${page.startPageNum}" end="${page.endPageNum}" var="num">
					 	<c:if test="${selected != num}">
					 		<li class="page-item"><a class="page-link" href="<%=request.getContextPath()%>/admin?num=${num}">${num}</a></li>
					 	</c:if>
 					...
 					<c:if test="${page.next}">
	 					<li class="page-item"><a class="page-link"  href="<%=request.getContextPath()%>/admin?num=${page.endPageNum + 1}"
