readIsAdminByUserID<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
<%@ page session="false"%>
	...
	<div class="container px-4 px-lg-5 respx-3 ">
		...
		<div class="collapse navbar-collapse" id="navbarResponsive">
			<div class="justify-content-md-center">
				<ul class="navbar-nav my-2 my-lg-0">
					<li class="nav-item nav-bottom-border mx-2 cursor-p"
						...
						class="nav-link cursor-p">총동연 소개</a></li>
			...
			<div class="justify-content-md-end">
				<ul class="navbar-nav my-2 my-lg-0">
					<li class="nav-item button-padding button-left border-none cursor-p">
					...
					<li class="nav-item button-padding border-none cursor-p">
						<button type="button" class=" login-btn btn-outline-secondary "
							onclick="location.href='<%=request.getContextPath()%>/loginGoogle'">로그인</button>
					</li>
				</ul>
			</div>
		</div>
